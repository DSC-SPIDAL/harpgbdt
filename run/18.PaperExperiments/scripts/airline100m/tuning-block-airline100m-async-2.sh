...
../bin/xgb-convergence.sh ${bin} airlinemeta 1000 $d lossguide 32 3125000 1 0 4 lossguide data_parallelism=1 group_parallel_cnt=32 topk=$k async_mixmode=2 loadmeta=airlinemeta

export RUNID=$tag-K$k-dp1mix0
../bin/xgb-convergence.sh ${bin} airlinemeta 1000 $d lossguide 32 3125000 1 0 4 lossguide data_parallelism=1 group_parallel_cnt=8 topk=$k async_mixmode=0 loadmeta=airlinemeta

export RUNID=$tag-K$k-dp1mix1
../bin/xgb-convergence.sh ${bin} airlinemeta 1000 $d lossguide 32 3125000 8 0 32 lossguide data_parallelism=1 group_parallel_cnt=32 topk=$k async_mixmode=1 loadmeta=airlinemeta
...
export RUNID=$tag-K$k-dp0mix2
../bin/xgb-convergence.sh ${bin} airlinemeta 1000 $d lossguide 32 3125000 2 0 4 lossguide data_parallelism=1 group_parallel_cnt=32 topk=$k async_mixmode=2 loadmeta=airlinemeta

export RUNID=$tag-K$k-dp1mix0
../bin/xgb-convergence.sh ${bin} airlinemeta 1000 $d lossguide 32 3125000 2 0 4 lossguide data_parallelism=1 group_parallel_cnt=8 topk=$k async_mixmode=0 loadmeta=airlinemeta
