...
../bin/xgb-speedup.sh ${bin} synsetmeta 300 8 lossguide 32 100000 28 0 8 lossguide data_parallelism=1 group_parallel_cnt=32 topk=1 async_mixmode=1 loadmeta=synsetmeta
../bin/xgb-speedup.sh ${bin} synsetmeta 300 12 lossguide 32 100000 28 0 8 lossguide data_parallelism=1 group_parallel_cnt=32 topk=32 async_mixmode=1 loadmeta=synsetmeta
../bin/xgb-speedup.sh ${bin} synsetmeta 300 16 lossguide 32 100000 28 0 8 lossguide data_parallelism=1 group_parallel_cnt=32 topk=32 async_mixmode=1 loadmeta=synsetmeta
