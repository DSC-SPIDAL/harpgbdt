...
../bin/xgb-strongscale.sh ${bin} synsetmeta 10 8 lossguide 100000 28 0 8 lossguide data_parallelism=1 group_parallel_cnt=32 topk=1 async_mixmode=1 loadmeta=synsetmeta
../bin/xgb-strongscale.sh ${bin} synsetmeta 10 12 lossguide 100000 28 0 8 lossguide data_parallelism=1 group_parallel_cnt=32 topk=32 async_mixmode=1 loadmeta=synsetmeta
../bin/xgb-strongscale.sh ${bin} synsetmeta 10 16 lossguide 100000 28 0 8 lossguide data_parallelism=1 group_parallel_cnt=32 topk=32 async_mixmode=1 loadmeta=synsetmeta
