...
# others
#
../bin/xgb-speedup.sh ${bin} higgsmeta 10 12 lossguide 36 312500 28 0 32 lossguide data_parallelism=1 group_parallel_cnt=32 topk=32 async_mixmode=1 loadmeta=higgsmeta

#hist
../bin/xgb-speedup.sh ${histbin} higgs 10 12  hist 36 500000 1 0 64 lossguide

#lightgbm
../bin/lightgbm-speedup-original.sh ${lightgbmbin} higgs 10 12 feature 36
