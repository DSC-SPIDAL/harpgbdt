...
../bin/xgb-speedup-0.sh ${bin} higgs 10 8 lossguide $thread $row 0 0 32 lossguide data_parallelism=1 group_parallel_cnt=32 topk=32 async_mixmode=2 savemeta=higgsmeta-${fid} data=higgs-${fid}.libsvm

../bin/xgb-speedup-0.sh ${bin} higgs 10 8 lossguide $thread $row 0 0 32 lossguide data_parallelism=1 group_parallel_cnt=32 topk=32 async_mixmode=1 data=higgs-${fid}.libsvm
