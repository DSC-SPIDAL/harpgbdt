...
## knob option
#knob_runsa_cache=MEM_LOAD_UOPS_RETIRED.L1_HIT_PS,MEM_LOAD_UOPS_RETIRED.L2_HIT_PS,MEM_LOAD_UOPS_RETIRED.L3_HIT_PS,MEM_LOAD_UOPS_RETIRED.L1_MISS,MEM_LOAD_UOPS_RETIRED.L2_MISS,MEM_LOAD_UOPS_RETIRED.L3_MISS,MEM_LOAD_UOPS_RETIRED.L1_MISS_PS,MEM_LOAD_UOPS_RETIRED.L2_MISS_PS,MEM_LOAD_UOPS_RETIRED.L3_MISS_PS
...
#knob_runsa_cache=MEM_LOAD_UOPS_RETIRED.L1_HIT_PS,MEM_LOAD_UOPS_RETIRED.L2_HIT_PS,MEM_LOAD_UOPS_RETIRED.L3_HIT_PS,MEM_LOAD_UOPS_RETIRED.L1_MISS,MEM_LOAD_UOPS_RETIRED.L2_MISS,MEM_LOAD_UOPS_RETIRED.L3_MISS
...
#echo "../bin/${Name} ${dataset}meta.conf num_round=100 nthread=${threadnum} tree_method=lossguide max_depth=0 bin_block_size=0 ft_block_size=4 row_block_size=312500 \
#node_block_size=32 grow_policy=lossguide max_leaves=256  data_parallelism=1 group_parallel_cnt=32 topk=32 async_mixmode=2 loadmeta=${dataset}meta"

#../bin/${Name} ${dataset}meta.conf num_round=10 nthread=${threadnum} tree_method=lossguide max_depth=0 bin_block_size=0 ft_block_size=4 row_block_size=312500 \
#node_block_size=32 grow_policy=lossguide max_leaves=256  data_parallelism=1 group_parallel_cnt=32 topk=32 async_mixmode=2 loadmeta=${dataset}meta &
