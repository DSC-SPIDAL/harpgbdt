...
../bin/xgb-speedup.sh ${bin2} criteometa 300 16 lossguide 32 1562500 33 0 8 depth data_parallelism=1 group_parallel_cnt=32 topk=128 async_mixmode=0 loadmeta=criteometa
