...
../bin/xgb-convergence.sh ${bin} yfccmeta 300 8 lossguide 32 $rowblksize 32 0 8 depth data_parallelism=0 group_parallel_cnt=32 topk=0 async_mixmode=2 loadmeta=yfccmeta missing_value=0
../bin/xgb-convergence.sh ${bin} yfccmeta 300 9 lossguide 32 $rowblksize 32 0 8 depth data_parallelism=1 group_parallel_cnt=32 topk=0 async_mixmode=2 loadmeta=yfccmeta missing_value=0
../bin/xgb-convergence.sh ${bin} yfccmeta 300 10 lossguide 32 $rowblksize 32 0 8 depth data_parallelism=1 group_parallel_cnt=32 topk=0 async_mixmode=2 loadmeta=yfccmeta missing_value=0

../bin/xgb-convergence.sh ${bin} yfccmeta 300 9 lossguide 32 $rowblksize 32 0 32 depth data_parallelism=1 group_parallel_cnt=32 topk=0 async_mixmode=1 loadmeta=yfccmeta missing_value=0
../bin/xgb-convergence.sh ${bin} yfccmeta 300 10 lossguide 32 $rowblksize 32 0 32 depth data_parallelism=1 group_parallel_cnt=32 topk=0 async_mixmode=1 loadmeta=yfccmeta missing_value=0
